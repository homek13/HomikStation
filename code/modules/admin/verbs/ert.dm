...
/datum/admins/proc/make_emergency_response_team(datum/ert/ertemplate = null, skip_preference_menu = FALSE)
	...
	while(numagents && candidates.len)
		...
		if(ertemplate.leader_role && ((chosen_candidate == earmarked_leader) || (numagents == 1 && !leader_spawned)))
